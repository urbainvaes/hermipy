...
int main()
{
    ...
    hermite::spmat sp_tensorized = tensorize_mats_axes<hermite::spmat, hermite::spmat>(sp_inputs, "triangle");
    hermite::mat tensorized = tensorize_mats_axes<hermite::mat, hermite::mat>(inputs, "triangle");
