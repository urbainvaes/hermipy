...
def solve_gaussian_2d(operator, fxy, variables):
    ...
    assert operator.subs(fxy, solution).doit().expand() == 0
...
class Fokker_Planck_1d:
    ...
    # Space variables
    variables = tuple(sym.symbols('x', real=True))
    ...
    def equation(cls, params):
        ...
        # Shorthand notations
        d, x, f = sym.diff, cls.x, cls.y, cls.f
